...
@Module({
  imports: [CorrelationModule, QcModule, EscalationModule, RecallModule, ProficiencyModule, ReportCenterModule, ResultSheetsModule, SecurityModule, ChangeRequestsModule],
