    ...
    <div style={{ position: 'relative' }}>
      ...
      {open && (
        <>
          ...
          {/* Always pure white (not the theme-tinted card colour) so the palette
              reads clean on every theme, including Cobalt/Dark. */}
          <div style={{ position: 'absolute', right: 0, top: 'calc(100% + 8px)', zIndex: 70, width: 340, background: '#ffffff', border: '1px solid #e6e9f2', borderRadius: 16, boxShadow: '0 20px 40px rgba(0,0,0,0.14)', padding: 14 }}>
