                    ...
                    <tr key={t.id} className="border-b border-[#F1F5F9] hover:bg-[#F8FAFC]">
                      ...
                      <td className="px-3 py-2.5">
                        <div className="flex items-center gap-1.5">
                          ...
                          {t.status === 'Failed' && <button onClick={() => retry.mutate(t.recordId)} className="flex items-center gap-1 rounded-lg border border-[#E2E8F0] px-2 py-1 text-[12px] font-semibold text-[#B45309]"><RefreshCw size={12} /> Retry</button>}
                        </div>
                      </td>
                    </tr>
                  );
