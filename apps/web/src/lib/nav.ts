...
export const NAV_GROUPS: NavGroup[] = [
  {
    ...
    icon: FlaskConical,
    items: [
      { label: 'Operations', path: '/operations', permission: 'record:view', feature: 'OPERATIONS_HUB', icon: Activity },
      { label: 'Quality & Governance', path: '/quality-governance', permission: 'record:view', feature: 'QUALITY_GOVERNANCE', icon: ClipboardCheck },
      { label: 'Enterprise Administration', path: '/enterprise-administration', permission: 'record:view', feature: 'ENTERPRISE_ADMINISTRATION', icon: Building2 },
      { label: 'Enterprise Case Management', path: '/command-center', permission: 'record:view', feature: 'ENTERPRISE_CASE_MGMT', icon: LayoutGrid },
