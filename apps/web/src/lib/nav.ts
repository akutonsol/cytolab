...
export const NAV_GROUPS: NavGroup[] = [
  {
    ...
    items: [
      ...
      { label: 'Enterprise Case Management', path: '/command-center', permission: 'record:view', icon: LayoutGrid },
      ...
      { label: 'Ancillary Orders', path: '/ancillary-orders', permission: 'record:view', icon: Microscope },
      { label: 'Screening Batches', path: '/screening-batches', permission: 'record:view', icon: Layers },
