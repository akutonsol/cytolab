  ...
  return (
    <section id="platform" style={{ borderBottom: '1px solid rgba(9,9,14,0.07)', overflow: 'hidden', position: 'relative' }}>
      ...
      <div ref={tickerRef} style={{ padding: '5rem 2.5rem 0' }}>
        <div style={{ marginBottom: '2.5rem' }}>{sTag('01 · The Problem')}</div>
      ...
      <div style={{
        ...
        borderBottom: '1px solid rgba(9,9,14,0.05)', padding: '1.1rem 0',
        background: 'rgba(9,9,14,0.02)', marginTop: '2rem',
      }}>
        <div className="marquee-h-track">
          {Array.from({ length: 8 }, (_, i) => (
            <span key={i} style={{
              ...
              padding: '0 2.5rem', flexShrink: 0, whiteSpace: 'nowrap',
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', borderTop: '1px solid rgba(9,9,14,0.07)' }}>
        <SectionReveal direction="left">
          <div style={{ padding: '3.5rem 3rem 4.5rem 2.5rem', borderRight: '1px solid rgba(9,9,14,0.07)' }}>
            <div style={{ marginBottom: '2rem' }}>{sTag('Current Reality')}</div>
          ...
          <div style={{ padding: '3.5rem 2.5rem 4.5rem 3rem' }}>
            ...
            <div style={{ background: '#4F46E5', padding: '2.5rem', borderRadius: '2px', color: '#fff' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '9px' }}>
                {solutions.map(s => (
                  <div key={s} style={{ display: 'flex', gap: '10px', fontSize: '0.78rem', color: 'rgba(255,255,255,0.7)' }}>
