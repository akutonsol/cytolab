...
commit; for 6B and 6C the governance authorization pinned the tag to the exact evidence head — `1c27092` for 6B,
`1e31c4f` for 6C, with the closeout/index commit kept as a descendant of the frozen evidence head) · **Accepted Tag**
