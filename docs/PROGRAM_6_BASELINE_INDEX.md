...
`1e31c4f` for 6C, `b20a69c` for 6D, `71efc5c` for 6E, with the closeout/index commit kept as a descendant of the frozen
evidence head) · **Accepted Tag** = annotated `p6-<phase>-accepted`. (6E's Implementation Candidate column shows the
