...
|---|---|
| Status | Active |
| Current Phase | Roadmap established; Osieri Phase 2 next |
| Owner | Founder |
...
Helix Design System (core, frozen v1.0)
        │
        ├── Osieri / CYTOLAB      product #1   (Active)
...
| 02 | [Osieri / CYTOLAB](02_OSIERI.md) | Active | Founder | P0 | Phase 1–3 shipped; Phase 2 (product) next | 2026-07-10 | Helix v1.0 |
...
| [../TECH_DEBT.md](../TECH_DEBT.md) | Osieri/platform debt backlog (TD-001…). |
